...
//        telemetry = new MultipleTelemetry(telemetry, FtcDashboard.getInstance().getTelemetry());
        ...
        Thread motorControl = new MotorControl();
        waitForStart();
    ...
    private class MotorControl extends Thread {
        public boolean manualStopRequested = true;
        public MotorControl() {
        ...
        public void run() {
            try {
                ...
                while (!isInterrupted() && !isStopRequested() && opModeIsActive() && !manualStopRequested) {
                    if (gamepad1.a) {
